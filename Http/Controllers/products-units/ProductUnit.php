...
class ProductUnit extends App
{
    ...
    public function productsUnits()
    {
        ...
        $ProductUnits = $this->db->select('SELECT * FROM products_units WHERE `status` = ? ', [1])->fetchAll();

        require_once(BASE_PATH . '/resources/views/app/products/products-units/product-units.php');
    }
