                ...
                success: function(response) {
                    if (response.status === 'success' && response.product) {
                        ...
                        if (product.unit_type && product.unit_type.trim() !== "") {
                            unitPriceBuy = product.package_price_buy / product.quantity_in_pack;
                            unitPriceSell = product.package_price_sell / product.quantity_in_pack;
                            $('input[name="unit_price_buy"]').val(formatNumber(unitPriceBuy)).parent().show();
                            $('input[name="unit_price_sell"]').val(formatNumber(unitPriceSell)).parent().show();
