    ...
    <div class="content">
        <div class="content-title">
            ...
            <span class="fs22">بــــرگــــشـت از فـــروش</span>
            <span class="twinkle-b"></span>
        ...
        <!-- modal -->
        <button id="openModal-cont" class="addBtn">برگشت از فروش</button>
        ...
        <div class="modal-overlay-cont" id="modalOverlay-cont">
            <div class="modal-cont border">
                <div class="colse-btn-modal d-flex align-center">
                    ...
                    <span class="mr10 bold">بــــرگــــشـت از فـــروش</span>

                    <?= $this->modalItems('return_sales') ?>
                ...
                <!-- js -->
                <?php include_once('resources/views/app/returns/return-from-sale/return-sale-script.php'); ?>
                ...
                <div class="product-modal d-flex mt15 flex-start">
                    ...
                    <div class="product-modal-left">
                        <div class="content-container border center pr">
                            ...
                            <form action="<?= url('close-return-sale-store') ?>" method="POST" enctype="multipart/form-data">
                                <div class="insert">
                                    <!-- search customer -->
                                    <div class="inputs d-flex">
                                        <div class="one">
