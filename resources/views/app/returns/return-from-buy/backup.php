    ...
    <div class="content">
        <div class="content-title pr">
            ...
            <span class="fs22">بــــــــرگــــشــتــــــ از خــــریــد</span>
            <span class="twinkle-b"></span>
                    ...
                    <div class="d-none my-form">
                        ...
                        <div class="inputs d-flex">
                            ...
                            <div class="one">
                                ...
                                <input type="text" class="" name="unit_price_buy" placeholder="نام دوا را وارد نمایید" maxlength="40" />
                            </div>
                        </div>
                        <!-- end price -->
        ...
        if ($return) { ?>
            ...
            <div class="content-container mb30">
                <div class="mb10 fs14"> اقلام برگشت از خرید، شماره: <?= $return['id'] ?> - فروشنده: <?= $user['user_name'] ?></div>
        ...
        <?php } else { ?>
            <div class="content-container">
                <div class="mb10 fs14 color-orange">
                    ...
                    <?php else: ?>
                        <span>بِل برگشت از خرید شماره <span><?= $return['id'] ?></span> باز است، اما لیست آن خالی است! <a href="<?= url('delete-return-invoice/' . $return['id']) ?>" class="color text-underline delete-invoice color-red">حذف بِل</a></span>
                    <?php endif; ?>
                </div>

                <div class="insert">
                    <form action="<?= url('close-return-buy-invoice') ?>" method="POST">
                        <div class="inputs d-flex">
                            <div class="one">
                            ...
                            <div class="one">
                                ...
                                <input type="hidden" class="d-none date-server dateInvoice" name="date" autofocus>
