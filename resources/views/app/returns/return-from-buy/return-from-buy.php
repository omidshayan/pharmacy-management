    ...
    <div class="content">
        <div class="content-title">
            ...
            <span class="fs22">بــــرگــــشـت از خــــریــــد</span>
            <span class="twinkle-b"></span>
        ...
        <!-- modal -->
        <button id="openModal-cont" class="addBtn">برگشت از خرید</button>
        ...
        <div class="modal-overlay-cont" id="modalOverlay-cont">
            <div class="modal-cont border">
                <div class="colse-btn-modal d-flex align-center">
                    ...
                    <span class="mr10 bold">بــــرگــــشـت از خــــریــــد</span>

                    <?= $this->modalItems('return_purchase') ?>
                ...
                <!-- js -->
                <?php include_once('resources/views/app/returns/return-from-buy/return-buy-script.php'); ?>
                ...
                <div class="product-modal d-flex mt15 flex-start">
                    ...
                    <div class="product-modal-left">
                        <div class="content-container border center pr">
                            ...
                            <form action="<?= url('close-return-buy-store') ?>" method="POST" enctype="multipart/form-data">
                                <div class="insert">
                                    <!-- search customer -->
                                    <div class="inputs d-flex">
                                        <div class="one">
                                            ...
                                            ?>
                                            <input type="hidden" name="user_id" id="seller_id" value="<?= !empty($seller['id']) ? $seller['id'] : '' ?>">
