...
<div class="content">
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="<?= url('cash-box-store') ?>" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14"><?= _name ?> <?= _star ?> </div>
                        <input type="text" name="name" class="checkInput" placeholder="نام صندوق را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                    <div class="one">
                        <div class="label-form mb5 fs14">نوع صندوق <?= _star ?></div>
                        <select name="type" class="checkSelect">
                            <option selected disabled>نوع صندوق را انتخاب نمایید</option>
                            <option value="cash">صندوق داخلی</option>
                            <option value="cash_center">صندوق مرکزی</option>
                ...
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <select name="currency" class="checkSelect">
                            <option selected disabled>نوع پول را انتخاب نمایید</option>
                            ...
                            <option value="kaldar">کالدار</option>
                        </select>
                    </div>
                    ...
                    <div class="one">
                        ...
                        <select name="allow_negative">
                            <option value="1">بله، مجاز است</option>
                            <option value="2">خیر، مجاز نیست</option>
                        </select>
                    </div>
                </div>
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <input type="number" name="opening_balance" placeholder="موجودی اولیه را وارد نمایید" autocomplete="off" />
                    </div>
                </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $item['name'] ?></td>
                        <td><?= $typeLabels[$item['type']] ?? 'نامشخص' ?></td>
                        <td><?= $currencyLabels[$item['currency']] ?? 'نامشخص' ?></td>

                        <td>
                            <a href="<?= url('edit-cash-box/' . $item['id']) ?>" class="color-orange">
