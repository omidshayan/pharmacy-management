...
<!-- Start content -->
<div class="content">
    <div class="content-title"> بِلهای خرید
        ...
        <table class="fl-table">
            <thead>
                <tr>
                    <th>#</th>
                    <th>شماره بِل</th>
                    <th>مبلغ کل <span class="color-orange"><?= _afghani ?></span></th>
                    <th>نام فروشنده</th>
                    <th>تاریخ</th>
                    <!-- <th>ویرایش</th> -->
                    <th>چاپ</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td> <?= $this->formatNumber($item['total_amount']) ?></td>
                        <td> <?= $item['seller_name'] ?> </td>

                        <td>
                            <span class="status">
                                <?= !empty($item['date'])
                                    ? jdate('Y/m/d', $item['date']) .
                                    '<span class="color-orange fs11"> (' . $this->calculateDaysText($item['date']) . ')</span>'
                                    : '<span class="text-danger fs12">تاریخ نامشخص</span>'; ?>
                            </span>
                        </td>
                        <td><a href="<?= url('item-print/' . $item['id']) ?>" class="color text-underline">چاپ</a></td>
                        <!-- <td>
                            <a href="<?= url('edit-buy-invoice/' . $item['id']) ?>" class="color-orange">
