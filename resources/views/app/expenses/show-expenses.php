...
<!-- Start content -->
<div class="content">
    <div class="content-title">نمایش مصارف 
    ...
    <div class="content-container mt20">
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($expenses, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $expense['title_expenses'] ?></td>
                        <td><?= $expense['category'] ?></td>

                        <td>
                            <?= number_format(intval($expense['price'])) ?>
                            <?= $expense['price'] != null ? '<span class="fs11">افغانی</span>' : '' ?>
                        </td>

                        <td>
                            <?= number_format(intval($expense['payment_expense'])) ?>
                            <?= $expense['payment_expense'] != null ? '<span class="fs11">افغانی</span>' : '' ?>
                        </td>

                        <td>
                            <?= number_format(intval($expense['remainder_expense'])) ?>
                            <?= $expense['remainder_expense'] != null ? '<span class="fs11">افغانی</span>' : '' ?>
                        </td>

                        <!-- <td>
                            <span class="status">
                                <?= ($expense['state'] == 1) ? '<span class="color-green">فعال</span>' : '<span class="color-red">غیرفعال</span>' ?>
                            </span>
                        </td> -->
                        <td>
                            <a href="<?= url('edit-expense/' . $expense['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('expense-details/' . $expense['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs14">تعداد کل: <?= count($expenses) ?></div>
            <?php
