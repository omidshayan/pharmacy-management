    ...
    $helps = [
        'close-form' => [
            ...
            'content' => '1. اگر فروشنده انتخاب نشود، به صورت خودکار فروشنده عمومی انتخاب می شود.
            </br>
    ...
    <div class="content">
        ...
        include_once('resources/views/helps/modal-product-infos.php');
        ?>

        <!-- modal -->
        <button id="openModal-cont" class="addBtn">ثبت خرید</button>
        ...
        <div class="modal-overlay-cont" id="modalOverlay-cont">
            <div class="modal-cont border">
                <div class="colse-btn-modal d-flex align-center">
                    ...
                    <span class="mr10 bold">خـــریـــد مـــحصــول جــــدیـــد</span>
                ...
                <!-- js -->
                <?php include_once('resources/views/helps/add-table.php'); ?>
                                ...
                                <div class="inputs d-flex">
                                    <div class="one">
                                        ...
                                        <input
                                            ...
                                            data-ajax-url="<?= url('search-product-purchase') ?>"
                                            ...
                                            data-hidden-fields="product_name, unit_type, package_price_buy, package_price_sell, unit_price_buy, unit_price_sell, quantity_in_pack" autocomplete="off" />

                                        <ul class="search-back t34 d-none live-search-result"></ul>
                                    </div>
                                </div>

                                <input type="hidden" id="selected_item_id" name="id" />
                        ...
                        <div class="content-container border center pr">
                            ...
                            <form action="<?= url('close-inventory-store') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="insert">
                                    ...
                                    <div class="inputs d-flex">
                                        <div class="one">
                                            <div class="label-form fs14">جستجوی فروشنده </div>
                                            <?php
                                            $seller = $seller ?? ['id' => '', 'user_name' => ''];
                                            ?>
                                            <input type="hidden" name="seller_id" id="seller_id" value="<?= !empty($seller['id']) ? $seller['id'] : '' ?>">
                                            <div id="user_details"></div>
                                            <input type="text" class="checkInput input-disable" name="search_seller" id="search_seller" value="<?= !empty($user['user_name']) ? $user['user_name'] : '' ?>" placeholder="نام فروشنده را جستجو نمایید" autocomplete="off" />
                                        </div>
                                    ...
                                    <div class="inputs d-flex">
                                        <div class="one">
                                            <div class="label-form mb5 fs14"> منبع پرداخت</div>
                                        ...
                                        <div class="insert">
                                            ...
                                            <div class="inputs d-flex">
                                                <div class="one">
                                                    ...
                                                    <input type="text" name="ref_id" placeholder="شماره بِل صادر شده از طرف فروشنده" autocomplete="off" />
                                                </div>
                                            </div>

                                            <!-- check warehouse -->
                                            <?php if (feature('warehouse')): ?>
                                                <div class="inputs d-flex">
                                                    <div class="one">
