    ...
    <div class="content">
        <div class="content-title">
            ...
            <span class="fs22">ثــبـت فاکــتـور فـــروش</span>
            <span class="twinkle-s"></span>
                ...
                <form action="<?= url('product-sale-store') ?>" method="POST" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="inputs d-flex">
                        <div class="one">
                            ...
                            <input type="text" class="checkInput" name="product_name" id="product_name" placeholder="نام دوا را جستجو نمایید" autocomplete="off" autofocus />
                        </div>
                    ...
                    <div class="d-none my-form">
                        ...
                        <div class="inputs d-flex mb30">
                            ...
                            <div class="one">
                                ...
                                <input type="text" class="checkInput-not" name="unit_price_sell" placeholder="نام دوا را وارد نمایید" maxlength="40" />
                            </div>
                        </div>
                        ...
                        <div class="inputs d-flex">
                            <div class="one">
                                ...
                                <input class="cursor-not" type="password" name="package_price_buy" readonly id="package_price_buy" placeholder="نام دوا را وارد نمایید" maxlength="40" />
                            ...
                            <div class="one">
                                ...
                                <input class="cursor-not" type="password" name="unit_price_buy" readonly id="unit_price_buy" placeholder="نام دوا را وارد نمایید" maxlength="40" />
                            </div>
                        </div>
        ...
        if ($sale_invoice) { ?>
            <div class="content-container mb30">
                <div class="mb10 fs14 d-flex"> اقلام بِل شماره: <?= $sale_invoice['invoice_number'] ?>
            ...
            <div class="content-container">
                <div class="mb10 fs14 color-orange">
                    <?php if (!empty($cart_lists) && isset($cart_lists[0]['total_price'])): ?>
                        مجموع بِل: <?= $this->formatNumber($cart_lists[0]['total_price']) ?>
                    ...
                    <form action="<?= url('close-sale-inventory-store') ?>" method="POST" enctype="multipart/form-data">
                        <div class="inputs d-flex">
                            <div class="one">
                                ...
                                <input type="number" class="all_price" name="paid_amount" placeholder="مبلغ پرداختی را وارد نمائید" />
                            </div>
                            <div class="one">
                                <div class="label-form mb5 fs14">تخفیف کلی بِل</div>
                                <input type="number" name="total_discount" class="sale_discount" placeholder="تخفیف را وارد نمائید" />
                            </div>
                        </div>
                        <div class="inputs d-flex">
                            <!-- <div class="one">
                            ...
                            <div class="one">
                                ...
                                <input type="hidden" class="d-none dateInvoice date-server" name="date" autofocus>
                                <input type="text" data-jdp class="start date-view cursor-p checkInput" />
                            </div>
                            <div class="one">
