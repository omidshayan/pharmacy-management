    ...
    <div class="content">
        ...
        <!-- modal -->
        <button id="openModal-cont" class="addBtn">ثبت بِل فروش</button>
        ...
        <div class="modal-overlay-cont" id="modalOverlay-cont">
            <div class="modal-cont border">
                <div class="colse-btn-modal d-flex align-center">
                    ...
                    <span class="mr10 bold">ثــبـت فاکــتـور فـــروش</span>
                ...
                <!-- js -->
                <?php include_once('resources/views/app/sales/script.php'); ?>
