...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت انبارها
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="warehouse-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام انبار <?= _star ?> </div>
                        <input type="text" name="product_cat_name" class="checkInput" value="<?= old('name') ?>" placeholder="نام انبار را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                    <div class="one">
                        <div class="label-form mb5 fs14">انتخاب مسئول انبار</div>
                        <select name="manager_id" id="">
                            <option selected disabled>لطفا مسئول را انتخاب نمائید</option>
                            <?php
                            foreach ($employees as $employee) { ?>
                                <option value="id"><?= $employee['employee_name'] ?></option>
                            <?php }
                            ?>
                        </select>
                    </div>
                ...
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <textarea name="descripton" id="" placeholder="آدرس انبار را وارد نمائید"></textarea>
                    </div>
                </div>
    ...
    <!-- show warehouse -->
    <div class="box-container">
        <div class="mb10 fs14"> انبار‌های ثبت شده</div>
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($warehouses, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-product-cat/' . $item['id']) ?>" class="color-orange">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($warehouses) ?></div>
            <?php
            ...
            <?php } else {
                if (count($warehouses) > 10) {
                    echo paginateView($warehouses, 10);
                }
            }
            ?>
        </div>
