...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت دسته بندی های محصولات
            ...
            <form id="myForm" action="product-cat-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <input type="text" name="product_cat_name" class="checkInput" value="<?= old('name') ?>" placeholder="نام را وارد نمایید" autocomplete="off" autofocus />
                    </div>
    ...
    <div class="box-container">
        ...
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($products_categories, $perPage);
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($products_categories) ?></div>
            <?php
            if (count($products_categories) == null) { ?>
                <div class="center color-red fs12">
                    <i class="fa fa-comment"></i>
                    <?= _not_infos ?>
                </div>
            <?php } else {
                if (count($products_categories) > 10) {
                    echo paginateView($products_categories, 10);
                }
            }
            ?>
        </div>
