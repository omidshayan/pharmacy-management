...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت واحد‌های شمارش
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="product-unit-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14"><?= _name ?> <?= _star ?> </div>
                        <input type="text" name="product_unit" class="checkInput" value="<?= old('name') ?>" placeholder="واحد شمارش را وارد نمایید" autocomplete="off" autofocus/>
                    </div>
                ...
                <!-- <div class="inputs d-flex">
                    <div class="text-right align-center">
                        <input type="checkbox" name="global" class="checkbox-select h13 m0" id="all-branch" checked />
                        <label for="all-branch" class="fs15">ثبت برای تمام شعبات</label>
                    </div>
                </div> -->
    ...
    <!-- show packages -->
    <div class="box-container">
        <div class="mb10 fs14"> واحد‌های ثبت شده</div>
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($ProductUnits, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-product-unit/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('product-unit-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($ProductUnits) ?></div>
            <?php
            if (count($ProductUnits) == null) { ?>
                <div class="center color-red fs12">
                    <i class="fa fa-comment"></i>
                    <?= _not_infos ?>
                </div>
            <?php } else {
                if (count($ProductUnits) > 10) {
                    echo paginateView($ProductUnits, 10);
                }
            }
            ?>
        </div>
